        ...
        <ul class="navbar-nav justify-content-end">
         ...
         <li class="nav-item dropdown">
          ...
          <li class="nav-item dropdown">
            ...
            <!-- NAVBAR DROPDOWN -->
            <ul class="dropdown-menu">
              <li><a class="dropdown-item active" href="guruforadmin.php">Guru</a></li>
  ...
  <div class="col-md-6">
       <form method="POST">
        <div class="input-group mb-3">
          <input type="text" name="t_cari" value="<?= @$_POST['t_cari'] ?>" class="form-control" placeholder="Masukkan Nama Guru">
    ...
    if (isset($_POST['b_cari'])) {
      ...
      $reset       = "SELECT * FROM guru WHERE nama like '%$keyword%' or nohp like '%$keyword%' or
      alamat like '%$keyword%' or pendidikan like '%$keyword%' order by nama asc";
    } else {
      $reset = "SELECT * FROM guru order by nama asc";
    }
    $guru = mysqli_query($koneksi, $reset);
    while ($data = mysqli_fetch_array($guru)) :
    ?>
       <tr>
          <td><?php echo $no; ?></td>
          <td style="text-align: center;"><img src="admin/imgGuru/<?php echo $data['foto']; ?>" style="width: 80px;"></td>
