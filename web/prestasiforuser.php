        ...
        <ul class="navbar-nav justify-content-end">
         ...
         <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item active" href="siswaxiforuser.php">Kelas XI</a></li>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item active" href="prestasiforuser.php">Prestasi</a></li>
            </ul>
          </li>
          <li class="nav-item">
  ...
  <div class="col-md-6">
       <form method="POST">
        <div class="input-group mb-3">
          <input type="text" name="t_cari" value="<?= @$_POST['t_cari'] ?>" class="form-control" placeholder="Masukkan Nama Prestasi">
