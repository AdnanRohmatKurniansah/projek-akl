...
<div class="content-page">
    <!-- Start content -->
    <div class="content">    
    <center><h1>Data Siswa Kelas XI</h1><center>
  <div class="add">
  <div class="add">
  <center><a href="tambah_siswaxi.php">+ &nbsp; Tambah Data</a><center></div>
    <br>
    ...
    if (isset($_POST['b_cari'])) {
      ...
      $reset       = "SELECT * FROM siswaxi WHERE nis like '%$keyword%' or nama like '%$keyword%' or
      alamat like '%$keyword%' or kelas like '%$keyword%' order by nis asc";
    } else {
      $reset = "SELECT * FROM siswaxi order by nis asc";
    }
    ...
    ?>
       ...
       <tr>
          ...
          <td>
              <a href="edit_siswaxi.php?id=<?php echo $data['id']; ?>" style="background-color: green; color: #fff;
          padding: 10px; text-decoration: none; font-size: 12px;">Edit</a> |
              <a href="proses_hapus1.php?id=<?php echo $data['id']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')" style="background-color: red; color: #fff;
