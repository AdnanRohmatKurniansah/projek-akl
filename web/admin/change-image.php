...
$query=mysqli_query($koneksi,"update tblposts set PostImage='$imgnewfile' where id='$postid'");
if($query)
{
...
<?php
$postid=intval($_GET['pid']);
$query=mysqli_query($koneksi,"select PostImage,PostTitle from tblposts where id='$postid' and Is_Active=1 ");
