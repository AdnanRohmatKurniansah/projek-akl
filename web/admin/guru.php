...
<div class="content-page">
  ...
  <center><a href="tambah_guru.php">+ &nbsp; Tambah Data</a><center></div>
    ...
    if (isset($_POST['b_cari'])) {
      ...
      alamat like '%$keyword%' order by nama asc";
    } else {
    ...
    ?>
       <tr>
          ...
          <td>
              <a href="editguru.php?id=<?php echo $data['id']; ?>" style="background-color: green; color: #fff;
          padding: 10px; text-decoration: none; font-size: 12px;">Edit</a> |
              <a href="proses_hapusguru.php?id=<?php echo $data['id']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')" style="background-color: red; color: #fff;
